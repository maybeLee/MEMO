...
class MutatorSelector:
    ...
    def __init__(self, initial_seed_mode=None, selection_mode=None, mutation_operator_list=None, architecture_pool=50):
        ...
        if initial_seed_mode == "synthesis":
            architecture_names, architecture_configs = self._load_initial_config("../data/synthesized_models/")
        elif initial_seed_mode == "origin":
            architecture_names, architecture_configs = self._load_initial_model("../data/origin_models/")
        elif initial_seed_mode == "test":
            architecture_names, architecture_configs = self._load_initial_config("../data/test_models/")
        else:
