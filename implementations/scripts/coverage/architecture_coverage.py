...
class ArchitectureMeasure(object):
    ...
    def get_architecture_diversity(self, model=None, mutant_name=None):
        ...
        self.mutant_diversity[mutant_name] = {"nodes": node_diversity, "edges": edge_diversity, "inputs": input_diversity}
    ...
    def shape_coverage(self):
        ...
        for layer_class in self.input_diversity:
            ...
            covered_shape_num += min(len(shape_list), self.SHAPE_SPACE)  # if the total number of shape is larger that SHAPE_SPACE, we set it as 100%
    ...
    def coverage(self):
        ...
        return api_cov, api_pair_cov, config_cov, input_cov, ndims_cov, dtype_cov, shape_cov
